    ...
    stage('Install_Maven') {
      steps {
        script {
          ...
          // Extract Maven zip
          bat 'C:/Program Files/7-Zip/7z x C:/ProgramData/Jenkins/jenkins/workspace/Win-Pipeline/apache-maven-3.8.4-bin.zip -oC:/ProgramData/Jenkins/jenkins/workspace/Win-Pipeline/'
